...
const Contact = () => {
  return (
    <div className="bg-[#fcfdfd] overflow-hidden ">
      ...
      >
        ...
        >
          <motion.div variants={fadeInUp}>
            <HeroTopTitle className="mb-4">Contact Hub</HeroTopTitle>
          </motion.div>
          <HeroContent>
            <motion.div variants={fadeInUp}>
              <HeroTitle className="text-5xl md:text-6xl mb-8 max-w-3xl">
                Let&apos;s Start Your{" "}
            ...
            <motion.div variants={fadeInUp}>
              <HeroSubTitle className="text-lg text-white/85 max-w-2xl">
                Whether you have a question about universities, visas, or
                anything else, our expert team in Dhaka is ready to guide you.
              </HeroSubTitle>
            </motion.div>
          </HeroContent>
        </motion.div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24 lg:mt-20 mt-14 relative z-20">
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
            ...
            <div className="bg-white border border-slate-100 p-10 rounded-[2.5rem] shadow-xl shadow-blue-900/5">
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-bold text-lg group-hover:text-primary transition-colors">
                      +880 1234 567 890
                    </p>
                  </div>
                </a>
                ...
                <a
                  href="mailto:support@agency.com"
                  className="flex items-start gap-5 group"
                >
                  <div className="p-4 rounded-2xl bg-blue-50 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300 shadow-sm">
                    <Mail size={22} />
              ...
              <div className="mt-12 pt-10 border-t border-slate-50">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-slate-400 text-[11px] italic mt-4">
                    Appointments are recommended for personalized counseling.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white border border-slate-100 p-10 md:p-14 rounded-[3rem] shadow-2xl shadow-primary/5 relative overflow-hidden">
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                <div className="space-y-3">
                  ...
                  <input
                    type="text"
                    className="w-full px-6 py-4 rounded-2xl border border-slate-100 bg-slate-50/50 focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/5 outline-none transition-all font-bold text-slate-800"
                ...
                <div className="md:col-span-2 space-y-3">
                  ...
                  <textarea
                    className="w-full px-6 py-5 rounded-[2rem] border border-slate-100 bg-slate-50/50 focus:bg-white focus:border-primary outline-none h-40 font-bold text-slate-800 transition-all"
