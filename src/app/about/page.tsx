...
const stories = [
  {
    ...
    quote:
      "The visa guidance I received was life-changing. I am now pursuing my dream in Canada thanks to the team's tireless support.",
    intake: "Fall 2025",
  },
  {
    name: "Samiul Islam",
    ...
    quote:
      "From SOP writing to final departure, every step was handled with extreme professionalism. Highly recommended!",
    intake: "Spring 2026",
  },
  {
    name: "Rafiul Islam",
    ...
    image:
      "https://thumbs.dreamstime.com/b/indian-man-student-shirt-posed-outdoor-229831859.jpg",
    quote:
      "I didn't trust any agency at first. But DGS sat with me for two hours on the first meeting,  no fees, no pressure. Just honest answers. That's when I knew these people were different. I landed in Missouri six months later with my I-20, my visa, and a part-time job already lined up.",
    intake: "Spring 2026",
  },
];
...
const team = [
  ...
  },
  {
    ...
    image:
      "https://static.vecteezy.com/system/resources/thumbnails/058/270/883/small/confident-young-man-posing-with-crossed-arms-in-casual-denim-shirt-png.png",
  },
  {
    name: "Maria Eades",
    role: "Director of People & Culture",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvCiFg3WKJJD9wl2z94g3-1oEAJ-Baul_GCw&s",
  },
  {
    name: "Tony Eades",
    role: "Chief Strategy Officer",
    image:
      "https://media.istockphoto.com/id/1682296067/photo/happy-studio-portrait-or-professional-man-real-estate-agent-or-asian-businessman-smile-for.webp?s=1024x1024&w=is&k=20&c=y4FFqpMLolCvEqoxlr4oypQqhAL1ta0ojXUnOofQXHk=",
  },
  {
    name: "Jason Feller",
    role: "Business Unit Director",
    image:
      "https://thumbs.dreamstime.com/b/profile-picture-smiling-millennial-asian-girl-isolated-grey-wall-background-look-camera-posing-headshot-portrait-happy-199290330.jpg",
  },
];
  ...
  return (
    <div className="bg-[#fcfdfd] min-h-screen pb-20 overflow-hidden">
      ...
      >
        ...
        >
          <motion.div variants={fadeInUp}>
            <HeroTopTitle className="mb-4">Our Global Impact</HeroTopTitle>
          </motion.div>
          <HeroContent>
            <motion.div variants={fadeInUp}>
              <HeroTitle>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-5xl mx-auto px-6 lg:mt-20 mt-14 mb-20 relative z-10"
      >
        <div>
          <StatsCounter />
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 border-t border-slate-50 pt-24">
        <div className="text-center mb-20">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-[11px] font-black text-slate-400 uppercase tracking-[0.2em]">
            {["Leadership", "Counseling", "Visa Team", "Marketing"].map(
              (tab, i) => (
                <button
                  key={i}
