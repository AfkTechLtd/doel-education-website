...
const stats = [
  { icon: Users,     value: "1,200+", label: "Total Attendees",   sub: "across all sessions"    },
  { icon: Mic2,      value: "35",     label: "Sessions in 2025",  sub: "online & in-person"     },
  { icon: MapPinned, value: "12",     label: "Cities Reached",    sub: "across Bangladesh"      },
  { icon: Star,      value: "4.9",    label: "Avg. Rating",       sub: "from post-event surveys"},
];
...
const pastEvents = [
  {
    ...
    outcome: "Students left with a personalised 6-university shortlist framework.",
  },
  {
    number: "02",
    ...
    outcome: "92% of participants reported higher confidence before their embassy appointment.",
  },
  {
    number: "03",
    ...
    outcome: "Covered 14 funding sources specific to Bangladeshi graduate applicants.",
  },
];
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[10px] md:text-xs text-gray-500 mt-0.5">{s.sub}</p>
                </div>
              </div>
            );
          })}
