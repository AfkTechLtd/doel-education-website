...
const intakeYears = ["Fall 2026", "Spring 2027", "Fall 2027", "Spring 2028", "Fall 2028"];
...
export default function BookingForm() {
  ...
  if (submitted) {
    return (
      <div className="border border-gray-200 shadow-lg rounded-2xl p-10 flex flex-col items-center justify-center text-center gap-4 min-h-[300px] bg-[linear-gradient(180deg,#ffffff_0%,#FFF6E0_100%)]">
        ...
        <h3 className="text-xl font-semibold text-slate-900 font-inter">You&apos;re booked!</h3>
        <p className="text-gray-500 font-semibold">We&apos;ll reach out within 24 hours to confirm your session time.</p>
        <button
  ...
  return (
    <div className="bg-white border border-gray-200 shadow-lg rounded-2xl p-8">
      <h2 className="text-2xl font-semibold font-inter text-slate-900 mb-1">Reserve Your Slot</h2>
      <p className="text-gray-500 text-sm font-semibold mb-7">Fill in your details and we&apos;ll confirm within 24 hours.</p>
